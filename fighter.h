...
void Fighter::drawHeroBlue()
{
    //fighter jet begins

    glPushMatrix();
    //glTranslatef(X, Y, 0.0);
    glScaled(0.3, 0.28, 0.0);
    glRotated(-90, 0, 0, 1);


    /// Additional tweaks begin
    ...
    glPushMatrix(); /// right mid

    glTranslatef(-0.48, -1.51, 0.0);
    glRotatef(633, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.25, 0.0, 0.0);
	glVertex3f(0.25, 0.03, 0.0);
    ...
    glTranslatef(0.05, -1.77, 0.0);
    glRotatef(117, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
    ...
    glTranslatef(-0.18, -1.34, 0.0);
    glRotatef(597, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
    ...
    glTranslatef(-0.43, -0.29, 0.0);
    glRotatef(261, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	...
	glPopMatrix(); /// left mid

    glPushMatrix();

    glTranslatef(0.29, 0.55, 0.0);
    glRotatef(24, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.22, 0.31, 0.56);
    ...
    glTranslatef(-0.21, -0.26, 0.0);
    //glRotatef(784, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	...
	glPushMatrix();
    glTranslated(0.079, 0, 0);
    glRotated(180, 0, 1, 0);

    glPushMatrix(); /// right head

    glTranslatef(-0.41, 0.62, 0.0);
    glRotatef(282, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.9, 0.0, 0.0);
	glVertex3f(0.9, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();
    ...
    glTranslatef(-0.38, 0.62, 0.0);
    glRotatef(876, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.35, 0.0, 0.0);
	glVertex3f(0.35, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();
    ...
    glTranslatef(-0.68, 0.74, 0.0);
    glRotatef(420, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.45, 0.0, 0.0);
	glVertex3f(0.45, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();
    ...
    glTranslatef(-0.46, 1.14, 0.0);
    glRotatef(801, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.7, 0.0, 0.0);
	glVertex3f(0.7, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();

	glPopMatrix(); /// right head
...
glPushMatrix(); /// left head
    ...
    glTranslatef(-1.25, 0.27, 0.0);
    glRotatef(535, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
    ...
    glTranslatef(-1.99, -0.34, 0.0);
    glRotatef(30, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.84, 0.0, 0.0);
	glVertex3f(0.84, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();
    ...
    glTranslatef(-1.98, -0.24, 0.0);
    glRotatef(754, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.88, 0.0, 0.0);
    ...
    glPushMatrix();
    glTranslated(0.0799998, 0, 0);
    glRotated(180, 0, 1, 0);

    glPushMatrix(); /// right wing

    glTranslatef(-1.82, -0.57, 0.0);
    ...
    glTranslatef(-0.38, -0.29, 0.0);
    glRotatef(370, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.03, 0.0, 0.0);
	glVertex3f(0.03, 0.32, 0.0);
    ...
    glTranslatef(-1.22, -0.54, 0.0);
    //glRotatef(377, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
    ...
    glTranslatef(-1.19, -0.24, 0.0);
    glRotatef(377, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.83, 0.0, 0.0);
	glVertex3f(0.83, 0.03, 0.0);
	glVertex3f(0.0, 0.03, 0.0);
	glEnd();
    ...
    glTranslatef(-1.86, -0.59, 0.0);
    glRotatef(380, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.0, 0.0, 0.0);
	glVertex3f(0.03, 0.0, 0.0);
    ...
    glTranslatef(-0.16, 1.9, 0.0);
    //glRotatef(85, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.05, 0.17, 0.28);
	glVertex3f(0.0, 0.0, 0.0);
	glVertex3f(0.4, 0.0, 0.0);
	glVertex3f(0.22, 0.4, 0.0);
	...
	glVertex3f(0.65, 0.0, 0.0);
	glVertex3f(0.51, 0.68, 0.0);
	glVertex3f(0.09, 0.68, 0.0);
	glEnd();
    ...
    glTranslatef(-0.36, 1.83, 0.0);
    //glRotatef(85, 0.0, 0.0, 1.0);
    //glScaled(.8, .8, 0);
    glBegin(GL_POLYGON);
    glColor3f(0.91, 0.89, 0.45);
    ...
    glTranslatef(2.28, -0.53, 0.0);
    glRotatef(180, 0.0, 1.0, 0.0);
    glScaled(0.2, 0.2, 0);
    glBegin(GL_POLYGON);
	//glColor3f(0.82, 0.83, 0.87);
    glColor3f(0.22, 0.37, 0.5);
	glVertex3f(0.8, -0.4, 0.0);
	glVertex3f(1.5, -1, 0.0);
	glVertex3f(10, 1.5, 0.0);
	glVertex3f(9, 6, 0.0);
	glVertex3f(8, 7, 0.0);
	glVertex3f(6, 5, 0.0);
    ...
    glTranslatef(-0.46, -0.73, 0.0);    //glRotatef(180, 0.0, 1.0, 0.0);
    glBegin(GL_POLYGON);
	glColor3f(0.22, 0.37, 0.5);
	glVertex3f(0.0, 0.0, 0.0);
    ...
    glTranslatef(-0.46, -0.86, 0.0);
    //glRotatef(180, 0.0, 1.0, 0.0);
    glBegin(GL_POLYGON);
    glColor3f(0.22, 0.31, 0.56);
    //glColor3f(0.85, 0.86, 0.9);
